...
int main(int argc, const char** argv)
{
	...
	while (--len >= 0)
	{
		...
		vitri++; // Tăng vị trí lên 1 để dành cho vòng lặp sau
	}

	// MẢNH GHÉP 3: Chốt chuỗi và in toàn văn kết quả ra màn hình
	total[vitri] = '\0'; // Thêm ký tự Null-terminator để chuẩn hóa chuỗi C
